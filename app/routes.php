...
$router->delete('/admin/subscriptions/(\d+)', 'Admin\\SubscriptionController@delete', ['middleware' => ['auth', 'admin'], 'permission' => 'manage_subscriptions']);
...
$router->delete('/admin/classes/(\d+)', 'Admin\\ClassController@delete', ['middleware' => ['auth', 'admin'], 'permission' => 'manage_classes']);
